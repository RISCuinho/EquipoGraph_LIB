#############################################################################
# Makefile for building: libEquipoGraph.so.1.0.0
# Generated by qmake (3.1) (Qt 5.9.5)
# Project:  EquipoGraph_LIB.pro
# Template: lib
# Command: /usr/lib/qt5/bin/qmake -o Makefile EquipoGraph_LIB.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DEQUIPOGRAPH_LIB_LIBRARY -DQT_DEPRECATED_WARNINGS -DQT_QML_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
CFLAGS        = -pipe -g -Wall -W -D_REENTRANT -fPIC $(DEFINES)
CXXFLAGS      = -pipe -g -Wall -W -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -isystem /usr/include/i386-linux-gnu/qt5 -isystem /usr/include/i386-linux-gnu/qt5/QtWidgets -isystem /usr/include/i386-linux-gnu/qt5/QtGui -isystem /usr/include/i386-linux-gnu/qt5/QtCore -I. -isystem /usr/include/libdrm -I/usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = EquipoGraph1.0.0
DISTDIR = /home/carlosdelfino/workspace/EquipoGraph/EquipoGraph_LIB/.tmp/EquipoGraph1.0.0
LINK          = g++
LFLAGS        = -shared -Wl,-soname,libEquipoGraph.so.1
...
SOURCES       = equipographlib.cpp \
		equipo.cpp \
		connection.cpp moc_equipographlib.cpp
OBJECTS       = equipographlib.o \
		equipo.o \
		connection.o \
		moc_equipographlib.o
DIST          = /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		EquipoGraph_LIB.pro equipographlib.h \
		equipograph_lib_global.h \
		equipo.h \
		connection.h equipographlib.cpp \
		equipo.cpp \
		connection.cpp
QMAKE_TARGET  = EquipoGraph
DESTDIR       = 
TARGET        = libEquipoGraph.so.1.0.0
TARGETA       = libEquipoGraph.a
TARGET0       = libEquipoGraph.so
TARGETD       = libEquipoGraph.so.1.0.0
TARGET1       = libEquipoGraph.so.1
TARGET2       = libEquipoGraph.so.1.0
...
Makefile: EquipoGraph_LIB.pro /usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile EquipoGraph_LIB.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents equipographlib.h equipograph_lib_global.h equipo.h connection.h $(DISTDIR)/
	$(COPY_FILE) --parents equipographlib.cpp equipo.cpp connection.cpp $(DISTDIR)/
...
moc_predefs.h: /usr/lib/i386-linux-gnu/qt5/mkspecs/features/data/dummy.cpp
	g++ -pipe -g -Wall -W -dM -E -o moc_predefs.h /usr/lib/i386-linux-gnu/qt5/mkspecs/features/data/dummy.cpp

compiler_moc_header_make_all: moc_equipographlib.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_equipographlib.cpp
moc_equipographlib.cpp: equipograph_lib_global.h \
		equipographlib.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++ -I/home/carlosdelfino/workspace/EquipoGraph/EquipoGraph_LIB -I/usr/include/i386-linux-gnu/qt5 -I/usr/include/i386-linux-gnu/qt5/QtWidgets -I/usr/include/i386-linux-gnu/qt5/QtGui -I/usr/include/i386-linux-gnu/qt5/QtCore -I/usr/include/c++/7 -I/usr/include/i386-linux-gnu/c++/7 -I/usr/include/c++/7/backward -I/usr/lib/gcc/i686-linux-gnu/7/include -I/usr/local/include -I/usr/lib/gcc/i686-linux-gnu/7/include-fixed -I/usr/include/i386-linux-gnu -I/usr/include equipographlib.h -o moc_equipographlib.cpp
...
equipographlib.o: equipographlib.cpp equipographlib.h \
		equipograph_lib_global.h \
		connection.h \
		equipo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o equipographlib.o equipographlib.cpp

equipo.o: equipo.cpp connection.h \
		equipo.h \
		equipographlib.h \
		equipograph_lib_global.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o equipo.o equipo.cpp

connection.o: connection.cpp connection.h \
		equipo.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o connection.o connection.cpp

moc_equipographlib.o: moc_equipographlib.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_equipographlib.o moc_equipographlib.cpp
